...
title: What should you think about when starting to use Viva goals
description: Some pointers for when planning to start to use Viva goals
tags: ['Viva Goals', 'Viva']
summary: A guide on what to think about when thinking to start using viva goals
authors: ['default']
---
...
Objectives and Key Results (OKRs) are a popular goal-setting framework that helps organizations align their strategic priorities, unite their teams around a common purpose, and measure their progress and impact. OKRs consist of two components: an objective, which is a qualitative statement of what you want to achieve, and key results, which are quantitative indicators of how you will know if you have achieved your objective.

Microsoft Viva Goals is a goal-alignment solution that integrates OKRs into the employee experience, empowering teams to be their best from anywhere. Viva Goals enables individuals and teams to create, track, and manage their OKRs within Microsoft 365 environment, using familiar tools like Teams, Outlook, SharePoint, Power BI, etc. Viva Goals also provides review dashboards, projects integration, feedback mechanisms, and other features to help users stay on track with their OKRs.

But how do you plan your OKRs using Viva Goals? What are some best practices and tips to make the most of this powerful tool? In this blog post, we will explore some aspects that one should consider when planning about when with Viva goals and OKRs.
...
- Define SMART objectives: Your objectives should be Specific (clearly defined), Measurable (quantifiable), Achievable (realistic), Relevant (meaningful), and Time-bound (deadline-oriented). A good objective should answer the questions: What do you want to achieve? Why does it matter? How will you measure success? When will you complete it? You can use Viva Goals to create objectives using natural language or templates .
...
- **Integrations:** You can integrate Viva Goals with other tools such as Microsoft Teams,
  Power BI,
  Outlook,
  SharePoint,
  and Yammer
...
# What should one think about when starting with Viva goals and OKRs
...
The last thing you should think about when starting with Viva Goals and OKRs is how you will check-in regularly with your team members on their progress towards their goals. Checking-in is an essential part of the OKR process as it helps you monitor performance,
identify issues,
celebrate successes,
provide feedback,
